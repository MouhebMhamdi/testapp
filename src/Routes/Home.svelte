...
<section class="full ">
<div class=" header flex flex-col items-center justify-center mx-auto px-6 bg-cover bg-center bg-gradient-to-r from-cyan-500 to-blue-500 bg-[url('./assets/background.jpg')]">
...
<div class="container">
    <div class="grid grid-rows-1 grid-flow-col gap-5 " >
      ...
      <div class="cards">
            <div class="card cols">
                <div class="header image row-span-6 bg-cover bg-center bg-gradient-to-r from-cyan-500 to-blue-500 bg-[url('./assets/tech.jpg')]">
                    <div class="max-w-lg cover overflow-hidden shadow-lg w-full"></div>
                </div>
            </div>
            <div class="card   cols">
            ...
            <div class="card col pb-9">
                <div class="header image row-span-6 bg-cover bg-center bg-gradient-to-r from-cyan-500 to-blue-500 bg-[url('./assets/tech.jpg')]">
                    <div class="max-w-lg cover overflow-hidden shadow-lg w-full"></div>
                </div>
            </div>
            <div class="card col mb-4 mt-4">
                <div class="p-4 w-full text-center bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    <h5 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Work fast from anywhere</h5>
                    <p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Stay up to date and move work forward with Flowbite on iOS &amp; Android. Download the app today.</p>
                    <div class="justify-center items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
